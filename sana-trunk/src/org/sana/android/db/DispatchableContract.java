 ...
 */
public final class DispatchableContract {
     ...
     * ...
     */
    public static final int DATABASE_VERSION = 1; // Reset this to 1 before release
     ...
     * @author Sana Development Team
     */
    public static final class Encounters implements BaseColumns {
        ...
        /** A Uri representing who or what the data was collected about. */
        public static final String SUBJECT = "_subject";
        
        /** A Uri representing the entity that collected the data */
        public static final String OBSERVER = "_observer";
        
        /** A Uri representing the instructions used to collected the data 
         *  Note: This will replace the PROCEDURE_ID
         */
        public static final String PROCEDURE = "_procedure";
    }
     ...
     *
     */
    public static final class EducationResources implements BaseColumns 
    {
    ...
    /**
     * Column definitions common to all records.
     * 
    ...
    /**
     * Common columns to provide identifiers for a record
     * 
     * @author Sana Development
     *
     */
    public static interface IdentifiableColumns{
    ...
    /**
     * Columns which describe a Concept object
     * 
     * @author Sana Development
     *
     */
    public static interface ConceptColumns {
    ...
    public static final class Concepts implements Columns, ConceptColumns,
    	IdentifiableColumns
    {
    	...
    	public static final Uri CONTENT_URI = Uri.withAppendedPath(
    			AUTHORITY_URI, "concept");
        
    }

    public static interface ConceptRelationshipColumns {

        public static final String RELATES_FROM = "from";
        
        public static final String RELATIONSHIP = "relates_as";
        
        public static final String RELATES_TO = "to";

    	public static final String CONSTRAINED_BY = "constrained_by";
        
    }
    
    public static final class ConceptRelationships implements 
    ConceptRelationshipColumns
    {
    	
    	private ConceptRelationships(){}
    	
    	/*** The content type for one or more records */
    	public static final String CONTENT_TYPE = 
    							"vnd.android.cursor.dir/org.sana.relationship";
    	
    	/** The content type for a single record*/
    	public static final String CONTENT_ITEM_TYPE = 
    							"vnd.android.cursor.item/org.sana.relationship";

    	/** The content style URI */
    	public static final Uri CONTENT_URI = Uri.withAppendedPath(
    			AUTHORITY_URI, "concept/relationship");
        
    }
    
    public static interface ObservationColumns {
    	...
    	/** Blob observation data. Synonym for the _data column */
    ...
    public static final class Observations implements ObservationColumns{
    	...
    	/** The content style URI */
    	public static final Uri CONTENT_URI = Uri.withAppendedPath(
    			AUTHORITY_URI, "encounter/observation");
        
    }
    
    public static interface ObserverColumns {
    	/** A system user identifier */
        public static final String NAME = "username";
        
    	/** A system user password hash */
        public static final String PASSWORD = "password";
    }
    
    /**
     * Column definitions for those collecting data. Essentially, the users of 
     * the system.
     * 
     * @author Sana Development
     *
     */
    public static final class Observers implements ObserverColumns,
    	IdentifiableColumns
    {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        DatabaseHelper(Context context) {
            super(context, DispatchableContract.DATABASE_NAME, null, DispatchableContract.DATABASE_VERSION);
        }
