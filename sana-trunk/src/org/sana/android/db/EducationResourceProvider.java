...
import org.sana.android.db.DispatchableContract.EducationResources;
...
public class EducationResourceProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        case ITEMS:
            return EducationResources.CONTENT_TYPE;
        case ITEM_ID:
            return EducationResources.CONTENT_ITEM_TYPE;
        default:
    ...
    public static void onCreateDatabase(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE + " ("
                + EducationResources._ID + " INTEGER PRIMARY KEY,"
                + ");");
    }
    ...
    static {
        ...
        sUriMatcher.addURI(DispatchableContract.EDUCATIONRESOURCE_AUTHORITY, TABLE, ITEMS);
        sUriMatcher.addURI(DispatchableContract.EDUCATIONRESOURCE_AUTHORITY, TABLE+"/#", ITEM_ID);
        
        sMediaProjectionMap = new HashMap<String, String>();
        sMediaProjectionMap.put(EducationResources._ID, EducationResources._ID);
    }
