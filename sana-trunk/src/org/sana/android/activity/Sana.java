...
public class Sana extends Activity implements View.OnClickListener {
    ...
    public static final int PICK_NAME = 7;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.data_visualization);
        View location = findViewById(R.id.moca_main_location);
        location.setOnClickListener(this);

        View name = findViewById(R.id.moca_main_name);
        name.setOnClickListener(this);

        View condition = findViewById(R.id.moca_main_condition);
        condition.setOnClickListener(this);
        
        View advanced = findViewById(R.id.moca_main_advanced);
    ...
    private void pickProcedure() {
        ...
        i.setType(Procedures.CONTENT_TYPE);
        i.setData(Procedures.CONTENT_URI);
    ...
    private void pickName() {
        Intent i = new Intent(Intent.ACTION_PICK);
        i.setType(.CONTENT_TYPE);
        i.setData(Name.CONTENT_URI);
        startActivityForResult(i, PICK_NAME);
    }
